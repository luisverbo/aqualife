...
export default function Ticker() {
  return (
    <div className="relative overflow-hidden bg-papel py-5">
      {/* fades nas bordas */}
        ...
        {[0, 1].map((copy) => (
          ...
          >
            {ITEMS.map((item) => (
              <span
                key={`${copy}-${item}`}
                className="flex items-center gap-3 px-6 font-mono text-[11px] font-medium uppercase tracking-[0.25em] text-tinta/50"
              >
